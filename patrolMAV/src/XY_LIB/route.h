...
/*patrol up*/
#define DELIVER_MAX_VEL_UP_TO_H1								(0.5)
#define DELIVER_MIN_VEL_UP_TO_H1								(0.5)	//0412, Lee
...
#define GOBACK_MAX_VEL_DOWN_LAND								(0.2)
#define GOBACK_MIN_VEL_DOWN_LAND								(0.2)	//0412, Lee
/*-----velocity for up down------*/
...
#define GOBACK_HEIGHT_OF_LAND										(-0.1)	// 01-27 delete the process of down to h3 

/*height diff*/
#define DELIVER_THRESHOLD_OF_UP_TO_H1_OUT						(0.2)	//0412, Lee
...
#define GOBACK_THRESHOLD_OF_DOWN_LAND_OUT						(0.01)	//0412,Lee
/*----------Height define---------*/



/*----------Height control para define---------*/
#define DELIVER_UP_TO_H1_KPZ									(0.2)	//0412, Lee
...
#define GOBACK_DOWN_LAND_KPZ									(0.2)
/*----------Height control para define---------*/
...
extern Autopilot_Interface XYI_Brain;
