...
#define MAX_Z_VEL_FOR_DROP				(0.25)	//0329
#define MIN_Z_VEL_FOR_DROP				(0.20)	//0329
...
#define CAM_INSTALL_DELTA_ROLL          (-1.0)      //when the camera head rotation right, +, add the angle
#define CAM_INSTALL_DELTA_PITCH         (0.0)      //when the camera head rotation up, +, add the angle
...
#define UP_DOWN_YAW_REDUCE				(0.95)	//0330(0.9 to 0.95)"XY_Ctrl_Drone_To_Assign_Height_Has_MaxVel_And_FP_DELIVER" use
